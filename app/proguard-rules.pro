...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
-keep class com.ding.healthmenu.bean.* { *; }
...
#下面中括号的地方需要要填你的包名
-keep public class com.ding.healthmenu.R$*{
...
-keep public class com.ding.util.* { *; }
-keep public class * extends com.ding.healthmenu.BaseActivity