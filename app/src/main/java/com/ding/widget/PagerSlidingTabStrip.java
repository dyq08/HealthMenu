...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public float getLineLeft_Right() {
		return lineLeft_Right;
	}

	public void setLineLeft_Right(float lineLeft_Right) {
		this.lineLeft_Right = lineLeft_Right;
	}

	//设置滑动指示器的lineLeft  lineRight
	private float lineLeft_Right=0;
	//private int tabBackgroundResId = R.drawable.background_tab;
	private int tabBackgroundResId = Color.parseColor("#ff0000");
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(lineLeft+lineLeft_Right, height - indicatorHeight, lineRight-lineLeft_Right, height, rectPaint);
